...
You also inspected the external Order Desk MCP, confirmed the boundary between automatic reads and approval-gated writes, and connected the registered MCP action to AI Agent Studio.
